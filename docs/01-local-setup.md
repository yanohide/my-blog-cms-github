...
- [ ] Cursor の AI で設計書を読み込ませてコードを生成した
- [ ] `http://localhost:3000` でサイトのトップページが表示される
- [ ] `http://localhost:3000/studio` で Sanity Studio（管理画面）が表示される
- [ ] Sanity Studio に Google アカウントでログインできる
